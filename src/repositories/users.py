...
class Users:
    ...
    async def update_user(self, data: UserIn, user_id: UUID):
        stmt = update(self.model).where(self.model.id == user_id).values(**data.model_dump()).returning(self.model.id,
                                                                        self.model.first_name,
                                                                        self.model.last_name,
                                                                        self.model.age,
                                                                        self.model.city,
    ...
    async def delete_user(self, data: UserIn, user_id: UUID) -> dict[str: str]:
